...
SOURCE_VP6_DECODER	       += vp3.c vp5.c vp6.c vp56.c vp56data.c vp3dsp.c vp6dsp.c huffman.c
SOURCE_APE_DECODER	       += apedec.c
...
SOURCE_MP2_DECODER             += mpegaudiodec.c mpegaudiodecheader.c mpegaudio.c mpegaudiodata.c
...
LOCAL_SRC_FILES += $(SOURCE_VP6_DECODER)
LOCAL_SRC_FILES += $(SOURCE_APE_DECODER)
...
LOCAL_SRC_FILES += $(SOURCE_MP2_DECODER)		
