...
#define GST_IS_FLUPS_DEMUX_CLASS(obj)     (G_TYPE_CHECK_CLASS_TYPE((klass), \
                                            GST_TYPE_FLUPS_DEMUX))
#define GST_TYPE_FLUPSSTREAM            (gst_flupsstream_get_type())
#define GST_FLUPSSTREAM(obj)            (G_TYPE_CHECK_INSTANCE_CAST((obj),\
                                         GST_TYPE_FLUPSSTREAM, GstFluPSStream))
#define GST_FLUPSSTREAM_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),\
                                         GST_TYPE_FLUPSSTREAM, GstFluPSStreamClass))
#define GST_FLUPSSTREAM_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj),\
                                         GST_TYPE_FLUPSSTREAM, GstFluPSStreamClass))
#define GST_IS_FLUPSSTREAM(obj)         (G_TYPE_CHECK_INSTANCE_TYPE((obj),\
                                         GST_TYPE_FLUPSSTREAM))
#define GST_IS_FLUPSSTREAM_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass),\
                                         GST_TYPE_FLUPSSTREAM))
typedef struct _GstFluPSStream GstFluPSStream;
typedef struct _GstFluPSStreamClass GstFluPSStreamClass;
